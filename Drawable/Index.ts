...
import { DrwableUnit, IDrwableUnit } from "./Items"

export const MapDrawable = new Map<string, DrwableUnit>()
...
export class DrawInteraction {
	...
	public Set<T extends IDrwableUnit>(class_: Constructor<DrwableUnit>, option: T) {
